...
public:
	...
	void SetAngles(const Vector& a2)
	{
		static auto setangles = reinterpret_cast<void(__thiscall*)(void*, const Vector&)>(
			tools::find_pattern("client.dll", "55 8B EC 56 57 8B F1 E8 ? ? ? ? 8B 7D 08"));
		setangles(this, a2);
	}
...
public:
	...
	__int64 GetBoneBase()
	{
		return *reinterpret_cast<__int64*>(uintptr_t(this) + 0x578);
	}
	...
	int GetMoveType()
	{
		return *reinterpret_cast<int*>(uintptr_t(this) + 0x178);
	}
	Vector m_vecVelocity()
	{
		return *reinterpret_cast<Vector*>(uintptr_t(this) + 0xf4);
	}
...
public:
	...
	int* Ducking()
	{
		return reinterpret_cast<int*>(uintptr_t(this) + 0x0E21);
	}
	int* Ducked()
	{
		return reinterpret_cast<int*>(uintptr_t(this) + 0x0E20);
	}
	float* Ducktime()
	{
		return reinterpret_cast<float*>(uintptr_t(this) + 0x0E24);
	}
